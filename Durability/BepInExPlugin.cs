...
{
    [BepInPlugin("aedenthorn.Durability", "Durability", "0.2.2")]
    public class BepInExPlugin: BaseUnityPlugin
    {
        ...
        public static ConfigEntry<float> otherDurabilityMultiplier;
        ...
        public void Awake()
        {
            ...
            fluidDurabilityMultiplier = Config.Bind<float>("Options", "FluidDurabilityMultiplier", 2, "Fluid item uses multiplier");
            foodDurabilityMultiplier = Config.Bind<float>("Options", "FoodDurabilityMultiplier", 2, "Food item uses multiplier");
            usableDurabilityMultiplier = Config.Bind<float>("Options", "UsableDurabilityMultiplier", 2, "Usable item uses multiplier");
            equipmentDurabilityMultiplier = Config.Bind<float>("Options", "EquipmentDurabilityMultiplier", 2, "Equipment item durability multiplier");
            otherDurabilityMultiplier = Config.Bind<float>("Options", "OtherDurabilityMultiplier", 2, "Misc item durability multiplier");
